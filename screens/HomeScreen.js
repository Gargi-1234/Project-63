...
//  <ImageBackground source={require('./dictionary.jpg')} resizeMode="cover"}>

  render(){
    return(
      <View style={{flex:1, borderWidth:2}}>
        
       <ImageBackground source={require('./dictionary.jpg')} resizeMode="cover" style={styles.imageStyle} >
        <Header
        ...
        <View style={styles.inputBoxContainer}>
          <Text style={{margin : 30}} > Search a Word.... </Text>
       {/*
        <Text 
           onChangeText={text => {
              this.setState({
